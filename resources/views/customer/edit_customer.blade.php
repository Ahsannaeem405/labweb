...
<div class="col-lg-6">
    <div class="form-group mg-b-10-force">
        ...
        <input type="text" value="{{ $cus->show->Parent_secondname  }}" name="Parent_secondname" class="form-control">
...
<div class="col-lg-6">
    <div class="form-group mg-b-10-force">
        ...
        <p>Parent_Surname :</p>
        <input type="text" value="{{ $cus->show->Parent_surname   }}" name="Parent_surname" class="form-control">
...
<div class="col-lg-6">
    <div class="form-group mg-b-10-force">
        ...
        <p>Parent_phone  :</p>
        <input type="text" value="{{ $cus->show->Parent_phone    }}" name="Parent_phone" class="form-control">
...
<div class="col-lg-6">
    <div class="form-group mg-b-10-force">
        ...
        <p>Parent_phone  :</p>
        <input type="date" value="{{ $cus->show->Parent_dob     }}" name="Parent_dob" class="form-control">
