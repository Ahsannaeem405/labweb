                            ...
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mg-b-10-force">
                                        ...
                                        {{-- @dd($cus->show->CruiseLine == 'Air Europa (UX)' ) --}}

                                        {{-- <option value="">{{ $cus->show->CruiseLine }} </option> --}}


                                        <select required name="CruiseLine" id="" class="form-control">


                                            <option value="Air Lingus (EI)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>Air Lingus (EI)
                                            </option>
                                            <option value="Aeroflot (SU)" @if ($cus->show->CruiseLine == 'Aeroflot (SU)') selected @endif>Aeroflot (SU) </option>
                                            <option value="Aerolineas Argentinas (AR)" @if ($cus->show->CruiseLine == 'Aerolineas Argentinas (AR)') selected @endif>Aerolineas
                                                Argentinas (AR)</option>
                                            <option value="Aeromexico (AM)" @if ($cus->show->CruiseLine == 'Aeromexico (AM)') selected @endif>Aeromexico (AM)
                                            </option>
                                            <option value="Air Canada (AC)" @if ($cus->show->CruiseLine == 'Air Canada (AC)') selected @endif>Air Canada (AC)
                                            </option>

                                            <option value="Air Century (Y2)" @if ($cus->show->CruiseLine == 'Air Century (Y2)') selected @endif>Air Century (Y2)
                                            </option>
                                            <option value="Air Europa (UX)" @if ($cus->show->CruiseLine == 'Air Europa (UX)') selected @endif>Air Europa (UX)
                                            </option>
                                            <option value="Air France (AF)" @if ($cus->show->CruiseLine == 'Air France (AF)') selected @endif>Air France (AF)
                                            </option>
                                            <option value="Alitalia (AZ)" @if ($cus->show->CruiseLine == 'Alitalia (AZ)') selected @endif>Alitalia (AZ)</option>
                                            <option value="American Airlines (AA)" @if ($cus->show->CruiseLine == 'American Airlines (AA)') selected @endif>American
                                                Airlines (AA)</option>
                                            <option value="Avianca (AV, TA)" @if ($cus->show->CruiseLine == 'Avianca (AV, TA)') selected @endif>Avianca (AV, TA)
                                            </option>
                                            <option value="Bahamasair (UP)" @if ($cus->show->CruiseLine == 'Bahamasair (UP)') selected @endif>Bahamasair (UP)
                                            </option>
                                            <option value="BOA-Boliviana de Aviacion (OB)" @if ($cus->show->CruiseLine == 'BOA-Boliviana de Aviacion (OB)') selected @endif>
                                                BOA-Boliviana de Aviacion (OB)</option>
                                            <option value="British Airways (BA)" @if ($cus->show->CruiseLine == 'British Airways (BA)') selected @endif>British Airways
                                                (BA)</option>
                                            <option value="Caribbean Airlines (BW)" @if ($cus->show->CruiseLine == 'Caribbean Airlines (BW)') selected @endif>Caribbean
                                                Airlines (BW)</option>
                                            <option value="Cayman Airways (KX)" @if ($cus->show->CruiseLine == 'Cayman Airways (KX)') selected @endif>Cayman Airways
                                                (KX)</option>

                                            <option value="COPA Airlines (CM)" @if ($cus->show->CruiseLine == 'COPA Airlines (CM)') selected @endif>COPA Airlines (CM)
                                            </option>
                                            <option value="Delta Air Lines (DL)" @if ($cus->show->CruiseLine == 'Delta Air Lines (DL)') selected @endif> Delta Air Lines
                                                (DL)</option>
                                            <option value="Eastern Airlines (2D)" @if ($cus->show->CruiseLine == 'Eastern Airlines (2D)') selected @endif>Eastern Airlines
                                                (2D)</option>
                                            <option value="El Al (LY)" @if ($cus->show->CruiseLine == 'El Al (LY)') selected @endif>El Al (LY)</option>
                                            <option value="Emirates (EK)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>Emirates (EK)</option>
                                            <option value="Finnair (AY)" @if ($cus->show->CruiseLine == 'Finnair (AY)') selected @endif>Finnair (AY)</option>
                                            <option value="Frontier Airlines (F9)" @if ($cus->show->CruiseLine == 'Frontier Airlines (F9)') selected @endif>Frontier
                                                Airlines (F9)</option>
                                            <option value="Iberia (IB)" @if ($cus->show->CruiseLine == 'Iberia (IB)') selected @endif>Iberia (IB)</option>
                                            <option value="JetBlue (B6)" @if ($cus->show->CruiseLine == 'JetBlue (B6)') selected @endif>JetBlue (B6)</option>
                                            <option value="KLM (KL)" @if ($cus->show->CruiseLine == 'KLM (KL)') selected @endif>KLM (KL)</option>
                                            <option value="LATAM Airlines (4M, JJ, LA,LP, XP)" @if ($cus->show->CruiseLine == 'LATAM Airlines (4M, JJ, LA,LP, XP)') selected @endif>
                                                LATAM Airlines (4M, JJ, LA,LP, XP)</option>
                                            <option value="LOT Polish Airlines (LO)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>LOT Polish
                                                Airlines (LO)</option>
                                            <option value="Lufthansa (LH)" @if ($cus->show->CruiseLine == 'Lufthansa (LH)') selected @endif>Lufthansa (LH)</option>
                                            <option value="Qatar (QR)" @if ($cus->show->CruiseLine == 'Qatar (QR)') selected @endif>Qatar (QR)</option>
                                            <option value="SAS (SK)" @if ($cus->show->CruiseLine == 'SAS (SK)') selected @endif>SAS (SK)</option>
                                            <option value="Southwest (WN)" @if ($cus->show->CruiseLine == 'Southwest (WN)') selected @endif>Southwest (WN)</option>
                                            <option value="Sun Country (SY)" @if ($cus->show->CruiseLine == 'Sun Country (SY)') selected @endif>Sun Country (SY)
                                            </option>
                                            <option value="Sunwing (WG)" @if ($cus->show->CruiseLine == 'Sunwing (WG)') selected @endif>Sunwing (WG)</option>
                                            <option value="Surinam Airways (PY)" @if ($cus->show->CruiseLine == 'Surinam Airways (PY)') selected @endif>Surinam Airways
                                                (PY)</option>
                                            <option value="Swift Air (SWQ)" @if ($cus->show->CruiseLine == 'Swift Air (SWQ)') selected @endif>Swift Air (SWQ)
                                            </option>
                                            <option value="Swiss International (LX)" @if ($cus->show->CruiseLine == 'Swiss International (LX)') selected @endif>Swiss
                                                International (LX)</option>
                                            <option value="TAP Air Portugal (TP)" @if ($cus->show->CruiseLine == 'TAP Air Portugal (TP)') selected @endif>TAP Air Portugal
                                                (TP)</option>
                                            <option value="TUIfly (TB, OR)" @if ($cus->show->CruiseLine == 'TUIfly (TB, OR)') selected @endif>TUIfly (TB, OR)
                                            </option>
                                            <option value="Turkish (TK)" @if ($cus->show->CruiseLine == 'Turkish (TK)') selected @endif>Turkish (TK)</option>
                                            <option value="United Airlines (UA)" @if ($cus->show->CruiseLine == 'United Airlines (UA)') selected @endif>United Airlines
                                                (UA)</option>
                                            <option value="Virgin Atlantic (VS)" @if ($cus->show->CruiseLine == 'Virgin Atlantic (VS)') selected @endif>Virgin Atlantic
                                                (VS)</option>
                                            <option value="Viva (VH)" @if ($cus->show->CruiseLine == 'Viva (VH)') selected @endif>Viva (VH)</option>
                                            <option value="Volaris (Y4)" @if ($cus->show->CruiseLine == 'Volaris (Y4)') selected @endif>Volaris (Y4)</option>
                                            <option value="WestJet (WS)" @if ($cus->show->CruiseLine == 'WestJet (WS)') selected @endif>WestJet (WS)</option>
                                            <option value="World Atlantic (WAL)" @if ($cus->show->CruiseLine == 'World Atlantic (WAL)') selected @endif>World Atlantic
                                                (WAL)</option>
                                            <option value="N/A" @if ($cus->show->CruiseLine == 'N/A') selected @endif>N/A</option>
                                            <option value="Azamara Club Cruises" @if ($cus->show->CruiseLine == 'Azamara Club Cruises') selected @endif>Azamara Club
                                                Cruises</option>
                                            <option value="Carnival" @if ($cus->show->CruiseLine == 'Carnival') selected @endif>Carnival</option>
                                            <option value="Celebrity X Cruises" @if ($cus->show->CruiseLine == 'Celebrity X Cruises') selected @endif>Celebrity X
                                                Cruises</option>
                                            <option value="Crystal Cruises" @if ($cus->show->CruiseLine == 'Crystal Cruises') selected @endif>Crystal Cruises
                                            </option>
                                            <option value="Disney Cruise Line" @if ($cus->show->CruiseLine == 'Disney Cruise Line') selected @endif>Disney Cruise Line
                                            </option>
                                            <option value="MSC Cruises" @if ($cus->show->CruiseLine == 'MSC Cruises') selected @endif>MSC Cruises</option>
                                            <option value="Norwegian Cruise Line" @if ($cus->show->CruiseLine == 'Norwegian Cruise Line') selected @endif>Norwegian Cruise
                                                Line</option>
                                            <option value="Oceania Cruises" @if ($cus->show->CruiseLine == 'Oceania Cruises') selected @endif>Oceania Cruises
                                            </option>
                                            <option value="Regent Seven Seas Cruises" @if ($cus->show->CruiseLine == 'Regent Seven Seas Cruises') selected @endif>Regent Seven
                                                Seas Cruises</option>
                                            <option value="Royal Caribbean International" @if ($cus->show->CruiseLine == 'Royal Caribbean International') selected @endif>Royal
                                                Caribbean International</option>
                                            <option value="Viking Ocean Cruises" @if ($cus->show->CruiseLine == 'Viking Ocean Cruises') selected @endif>Viking Ocean
                                                Cruises</option>
                                            <option value="Virgin Voyages" @if ($cus->show->CruiseLine == 'Virgin Voyages') selected @endif>Virgin Voyages</option>
                                            <option value="AIDA" @if ($cus->show->CruiseLine == 'AIDA') selected @endif>AIDA</option>
                                            <option value="Hapag-Lloyd" @if ($cus->show->CruiseLine == 'Hapag-Lloyd') selected @endif>Hapag-Lloyd</option>
                                            <option value="Hurtigruten" @if ($cus->show->CruiseLine == 'Hurtigruten') selected @endif>Hurtigruten</option>
                                            <option value="PampO Cruises" @if ($cus->show->CruiseLine == 'PampO Cruises') selected @endif>P&amp;amp;O Cruises
                                            </option>
                                            <option value="Phoenix" @if ($cus->show->CruiseLine == 'Phoenix') selected @endif>Phoenix</option>
                                            <option value="Pricess Cruises" @if ($cus->show->CruiseLine == 'Pricess Cruises') selected @endif>Pricess Cruises
                                            </option>
                                            <option value="SAGA" @if ($cus->show->CruiseLine == 'SAGA') selected @endif>SAGA</option>
                                            <option value="SCENIC Luxury Cruises" @if ($cus->show->CruiseLine == 'SCENIC Luxury Cruises') selected @endif>SCENIC Luxury
                                                Cruises</option>
                                            <option value="SEABOURN" @if ($cus->show->CruiseLine == 'SEABOURN') selected @endif>SEABOURN</option>
                                            <option value="TUI Cruises" @if ($cus->show->CruiseLine == 'TUI Cruises') selected @endif>TUI Cruises</option>
                                            <option value="Windstar Cruises" @if ($cus->show->CruiseLine == 'Windstar Cruises') selected @endif>Windstar Cruises
                                            </option>
                ...
                <form method="POST" action="{{ url('' . $role . '/customer/update_minor') }}">
                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <p>Gender : <span class="tx-danger">*</span> <i style="color: red; padding-left: 8px;"
                                        class="fas fa-check forverify forverify1"></i>
                                </p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <p>Town: <i style="color: red; padding-left: 8px;" class="fas fa-check forverify"></i>
                                    </p>
                                    <input type="text" value="{{ $cus->show->town }}" name="town"
                                        class="form-control">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <p>Zip : <i style="color: red; padding-left: 8px;" class="fas fa-check forverify"></i>
                                    </p>
                                ...
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select name="Country" required class="form-control">
                                        ...
                                        @foreach ($Country as $Countries)
                                            ...
                                            <option value="{{ $Countries->name }}" @if ($cus->show->Country == $Countries->name) selected @endif>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select required name="CruiseLine" id="" class="form-control">
                            ...
                            <option value="Air Lingus (EI)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>Air Lingus (EI)</option>
                            <option value="Aeroflot (SU)" @if ($cus->show->CruiseLine == 'Aeroflot (SU)') selected @endif>Aeroflot (SU) </option>
                            <option value="Aerolineas Argentinas (AR)" @if ($cus->show->CruiseLine == 'Aerolineas Argentinas (AR)') selected @endif>Aerolineas Argentinas (AR)
                            </option>
                            <option value="Aeromexico (AM)" @if ($cus->show->CruiseLine == 'Aeromexico (AM)') selected @endif>Aeromexico (AM)</option>
                            <option value="Air Canada (AC)" @if ($cus->show->CruiseLine == 'Air Canada (AC)') selected @endif>Air Canada (AC)</option>

                            <option value="Air Century (Y2)" @if ($cus->show->CruiseLine == 'Air Century (Y2)') selected @endif>Air Century (Y2)</option>
                            <option value="Air Europa (UX)" @if ($cus->show->CruiseLine == 'Air Europa (UX)') selected @endif>Air Europa (UX)</option>
                            <option value="Air France (AF)" @if ($cus->show->CruiseLine == 'Air France (AF)') selected @endif>Air France (AF)</option>
                            <option value="Alitalia (AZ)" @if ($cus->show->CruiseLine == 'Alitalia (AZ)') selected @endif>Alitalia (AZ)</option>
                            <option value="American Airlines (AA)" @if ($cus->show->CruiseLine == 'American Airlines (AA)') selected @endif>American Airlines (AA)
                            </option>
                            <option value="Avianca (AV, TA)" @if ($cus->show->CruiseLine == 'Avianca (AV, TA)') selected @endif>Avianca (AV, TA)</option>
                            <option value="Bahamasair (UP)" @if ($cus->show->CruiseLine == 'Bahamasair (UP)') selected @endif>Bahamasair (UP)</option>
                            <option value="BOA-Boliviana de Aviacion (OB)" @if ($cus->show->CruiseLine == 'BOA-Boliviana de Aviacion (OB)') selected @endif>BOA-Boliviana de
                                Aviacion (OB)</option>
                            <option value="British Airways (BA)" @if ($cus->show->CruiseLine == 'British Airways (BA)') selected @endif>British Airways (BA)</option>
                            <option value="Caribbean Airlines (BW)" @if ($cus->show->CruiseLine == 'Caribbean Airlines (BW)') selected @endif>Caribbean Airlines (BW)
                            </option>
                            <option value="Cayman Airways (KX)" @if ($cus->show->CruiseLine == 'Cayman Airways (KX)') selected @endif>Cayman Airways (KX)</option>

                            <option value="COPA Airlines (CM)" @if ($cus->show->CruiseLine == 'COPA Airlines (CM)') selected @endif>COPA Airlines (CM)</option>
                            <option value="Delta Air Lines (DL)" @if ($cus->show->CruiseLine == 'Delta Air Lines (DL)') selected @endif> Delta Air Lines (DL)</option>
                            <option value="Eastern Airlines (2D)" @if ($cus->show->CruiseLine == 'Eastern Airlines (2D)') selected @endif>Eastern Airlines (2D)</option>
                            <option value="El Al (LY)" @if ($cus->show->CruiseLine == 'El Al (LY)') selected @endif>El Al (LY)</option>
                            <option value="Emirates (EK)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>Emirates (EK)</option>
                            <option value="Finnair (AY)" @if ($cus->show->CruiseLine == 'Finnair (AY)') selected @endif>Finnair (AY)</option>
                            <option value="Frontier Airlines (F9)" @if ($cus->show->CruiseLine == 'Frontier Airlines (F9)') selected @endif>Frontier Airlines (F9)
                            </option>
                            <option value="Iberia (IB)" @if ($cus->show->CruiseLine == 'Iberia (IB)') selected @endif>Iberia (IB)</option>
                            <option value="JetBlue (B6)" @if ($cus->show->CruiseLine == 'JetBlue (B6)') selected @endif>JetBlue (B6)</option>
                            <option value="KLM (KL)" @if ($cus->show->CruiseLine == 'KLM (KL)') selected @endif>KLM (KL)</option>
                            <option value="LATAM Airlines (4M, JJ, LA,LP, XP)" @if ($cus->show->CruiseLine == 'LATAM Airlines (4M, JJ, LA,LP, XP)') selected @endif>LATAM Airlines
                                (4M, JJ, LA,LP, XP)</option>
                            <option value="LOT Polish Airlines (LO)" @if ($cus->show->CruiseLine == 'Air Lingus (EI)') selected @endif>LOT Polish Airlines (LO)
                            </option>
                            <option value="Lufthansa (LH)" @if ($cus->show->CruiseLine == 'Lufthansa (LH)') selected @endif>Lufthansa (LH)</option>
                            <option value="Qatar (QR)" @if ($cus->show->CruiseLine == 'Qatar (QR)') selected @endif>Qatar (QR)</option>
                            <option value="SAS (SK)" @if ($cus->show->CruiseLine == 'SAS (SK)') selected @endif>SAS (SK)</option>
                            <option value="Southwest (WN)" @if ($cus->show->CruiseLine == 'Southwest (WN)') selected @endif>Southwest (WN)</option>
                            <option value="Sun Country (SY)" @if ($cus->show->CruiseLine == 'Sun Country (SY)') selected @endif>Sun Country (SY)</option>
                            <option value="Sunwing (WG)" @if ($cus->show->CruiseLine == 'Sunwing (WG)') selected @endif>Sunwing (WG)</option>
                            <option value="Surinam Airways (PY)" @if ($cus->show->CruiseLine == 'Surinam Airways (PY)') selected @endif>Surinam Airways (PY)</option>
                            <option value="Swift Air (SWQ)" @if ($cus->show->CruiseLine == 'Swift Air (SWQ)') selected @endif>Swift Air (SWQ)</option>
                            <option value="Swiss International (LX)" @if ($cus->show->CruiseLine == 'Swiss International (LX)') selected @endif>Swiss International (LX)
                            </option>
                            <option value="TAP Air Portugal (TP)" @if ($cus->show->CruiseLine == 'TAP Air Portugal (TP)') selected @endif>TAP Air Portugal (TP)</option>
                            <option value="TUIfly (TB, OR)" @if ($cus->show->CruiseLine == 'TUIfly (TB, OR)') selected @endif>TUIfly (TB, OR)</option>
                            <option value="Turkish (TK)" @if ($cus->show->CruiseLine == 'Turkish (TK)') selected @endif>Turkish (TK)</option>
                            <option value="United Airlines (UA)" @if ($cus->show->CruiseLine == 'United Airlines (UA)') selected @endif>United Airlines (UA)</option>
                            <option value="Virgin Atlantic (VS)" @if ($cus->show->CruiseLine == 'Virgin Atlantic (VS)') selected @endif>Virgin Atlantic (VS)</option>
                            <option value="Viva (VH)" @if ($cus->show->CruiseLine == 'Viva (VH)') selected @endif>Viva (VH)</option>
                            <option value="Volaris (Y4)" @if ($cus->show->CruiseLine == 'Volaris (Y4)') selected @endif>Volaris (Y4)</option>
                            <option value="WestJet (WS)" @if ($cus->show->CruiseLine == 'WestJet (WS)') selected @endif>WestJet (WS)</option>
                            <option value="World Atlantic (WAL)" @if ($cus->show->CruiseLine == 'World Atlantic (WAL)') selected @endif>World Atlantic (WAL)</option>
                            <option value="N/A" @if ($cus->show->CruiseLine == 'N/A') selected @endif>N/A</option>
                            <option value="Azamara Club Cruises" @if ($cus->show->CruiseLine == 'Azamara Club Cruises') selected @endif>Azamara Club Cruises</option>
                            <option value="Carnival" @if ($cus->show->CruiseLine == 'Carnival') selected @endif>Carnival</option>
                            <option value="Celebrity X Cruises" @if ($cus->show->CruiseLine == 'Celebrity X Cruises') selected @endif>Celebrity X Cruises</option>
                            <option value="Crystal Cruises" @if ($cus->show->CruiseLine == 'Crystal Cruises') selected @endif>Crystal Cruises</option>
                            <option value="Disney Cruise Line" @if ($cus->show->CruiseLine == 'Disney Cruise Line') selected @endif>Disney Cruise Line</option>
                            <option value="MSC Cruises" @if ($cus->show->CruiseLine == 'MSC Cruises') selected @endif>MSC Cruises</option>
                            <option value="Norwegian Cruise Line" @if ($cus->show->CruiseLine == 'Norwegian Cruise Line') selected @endif>Norwegian Cruise Line</option>
                            <option value="Oceania Cruises" @if ($cus->show->CruiseLine == 'Oceania Cruises') selected @endif>Oceania Cruises</option>
                            <option value="Regent Seven Seas Cruises" @if ($cus->show->CruiseLine == 'Regent Seven Seas Cruises') selected @endif>Regent Seven Seas Cruises
                            </option>
                            <option value="Royal Caribbean International" @if ($cus->show->CruiseLine == 'Royal Caribbean International') selected @endif>Royal Caribbean
                                International</option>
                            <option value="Viking Ocean Cruises" @if ($cus->show->CruiseLine == 'Viking Ocean Cruises') selected @endif>Viking Ocean Cruises</option>
                            <option value="Virgin Voyages" @if ($cus->show->CruiseLine == 'Virgin Voyages') selected @endif>Virgin Voyages</option>
                            <option value="AIDA" @if ($cus->show->CruiseLine == 'AIDA') selected @endif>AIDA</option>
                            <option value="Hapag-Lloyd" @if ($cus->show->CruiseLine == 'Hapag-Lloyd') selected @endif>Hapag-Lloyd</option>
                            <option value="Hurtigruten" @if ($cus->show->CruiseLine == 'Hurtigruten') selected @endif>Hurtigruten</option>
                            <option value="PampO Cruises" @if ($cus->show->CruiseLine == 'PampO Cruises') selected @endif>P&amp;amp;O Cruises</option>
                            <option value="Phoenix" @if ($cus->show->CruiseLine == 'Phoenix') selected @endif>Phoenix</option>
                            <option value="Pricess Cruises" @if ($cus->show->CruiseLine == 'Pricess Cruises') selected @endif>Pricess Cruises</option>
                            <option value="SAGA" @if ($cus->show->CruiseLine == 'SAGA') selected @endif>SAGA</option>
                            <option value="SCENIC Luxury Cruises" @if ($cus->show->CruiseLine == 'SCENIC Luxury Cruises') selected @endif>SCENIC Luxury Cruises</option>
                            <option value="SEABOURN" @if ($cus->show->CruiseLine == 'SEABOURN') selected @endif>SEABOURN</option>
                            <option value="TUI Cruises" @if ($cus->show->CruiseLine == 'TUI Cruises') selected @endif>TUI Cruises</option>
                            <option value="Windstar Cruises" @if ($cus->show->CruiseLine == 'Windstar Cruises') selected @endif>Windstar Cruises</option>
