...
<body>
    ...
    <div class="row" style="padding-top: 6px;margin-top: 23px;">
        ...
        <div class="col-md-12" style="text-align: end;margin-top: 31px;">
            <button class="btn btn-primary" id="sig-submitBtn2" data-dismiss="modal">Accept Signature</button>
            <button class="btn btn-default" id="sig-clearBtn2">Clear</button>
        </div>


        <div class="col-md-12">
            <textarea style="display: none" id="sig-dataUrl2" class="form-control"
